...
public class BookingTests {
    ...
    public static void Setup() {
        ...
        String checkout = LocalDate.now().plusDays(3).format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        faker = new Faker();
    ...
    /* criei um cenário de teste para deletar o Booking, no entanto,
   a API não está funcionando para testar a funcinalidade */
    @Test
